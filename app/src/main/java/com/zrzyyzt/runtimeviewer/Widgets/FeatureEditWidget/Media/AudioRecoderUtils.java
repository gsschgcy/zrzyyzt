package com.zrzyyzt.runtimeviewer.Widgets.FeatureEditWidget.Media;
...
public class AudioRecoderUtils {
    ...
    private boolean isActie=false;//是否处于活动状态
    ...
    public void startRecord(String name_guid) {
        // 开始录音
        ...
        try {
            ...
            if (name_guid!=null){
                filePath = FolderPath+ File.separator + name_guid + ".amr" ;
            }else{
