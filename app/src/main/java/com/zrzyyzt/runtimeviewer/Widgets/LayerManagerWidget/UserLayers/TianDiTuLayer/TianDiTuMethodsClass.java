package com.zrzyyzt.runtimeviewer.Widgets.LayerManagerWidget.UserLayers.TianDiTuLayer;
...
public class TianDiTuMethodsClass {
    private static final String TAG = "TianDiTuMethodsClass";
    ...
    private static final String key = "1a2360bdad0e682aba76bfb388fcb849";
        ...
        try {
            switch (layerType) {
                ...
                case TIANDITU_VECTOR_MERCATOR:
                    ...
                    mainName = URL_VECTOR_ANNOTATION_CHINESE_MERCATOR;
                    mainIs2000 = false;
                    break;
                case TIANDITU_IMAGE_MERCATOR:
                    mainUrl = URL_IMAGE_MERCATOR;
                    mainName = URL_IMAGE_ANNOTATION_CHINESE_MERCATOR;
                    mainIs2000 = false;
                    break;
                default:
                    break;
