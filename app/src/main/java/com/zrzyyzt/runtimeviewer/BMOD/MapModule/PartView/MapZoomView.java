...
public class MapZoomView extends LinearLayout {
    ...
    private LinearLayout zoomInLayout, zoomoutLayout;
    ...
    public MapZoomView(Context context, @Nullable AttributeSet attrs){
        this(context, attrs,0);
    }

    public MapZoomView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        LayoutInflater.from(context).inflate(R.layout.map_zoom_view, this);
    ...
    public void init(MapView mapView, ZoomClickListener zoomClickListener) {
    ...
    private void initAttr(TypedArray ta){
        ...
        zoomInImage=ta.getResourceId(R.styleable.ViewAttr_zoom_in_image,R.drawable.map_zoomin);
        zoomOutImage=ta.getResourceId(R.styleable.ViewAttr_zoom_out_image,R.drawable.map_zoomout);
    ...
    private void setZoomDpHeight(int h){
        ...
        LayoutParams linearParams =(LayoutParams) spiltLineView2.getLayoutParams();
