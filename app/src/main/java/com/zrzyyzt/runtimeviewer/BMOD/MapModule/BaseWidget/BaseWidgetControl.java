...
public class BaseWidgetControl {
    ...
    public void setWidth(int width){
        if(baseWigetView!=null){
            RelativeLayout widgetview = baseWigetView.findViewById(R.id.base_widget_view_widgetview);
            if(widgetview!=null){
                LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams)widgetview.getLayoutParams();
                lp.width = width;
