...
import com.zrzyyzt.runtimeviewer.EventBus.BaseWidgetMsgEvent;
...
//            LinearLayout relativeLayout = widgetContextView.findViewById(R.id.subhello);
//            Log.d(TAG, "fullscreen: " + widgetContextView.toString() + "," + relativeLayout.toString());
//
//            if(relativeLayout!=null){
//                Log.d(TAG, "fullscreen: w: "+relativeLayout.getWidth()+"h: " +relativeLayout.getHeight() );
