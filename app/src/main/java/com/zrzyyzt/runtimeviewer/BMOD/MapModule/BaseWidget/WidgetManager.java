...
public class WidgetManager {
    ...
    public void setWidgetBtnView(int id, TextView textView, ImageView imageView) {
        BaseWidget baseWidget = mInstanceWidget.get(id);
        Log.i(TAG, "setWidgetBtnView: " + baseWidget);
        baseWidget.setWidgetBtnView(textView, imageView);
    }

    public void setWidth(int width){
        baseWidgetControl.setWidth(width);
    }
}
