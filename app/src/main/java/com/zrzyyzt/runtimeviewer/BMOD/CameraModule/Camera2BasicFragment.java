...
public class Camera2BasicFragment extends Fragment
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        Log.d(TAG, "chooseOptimalSize: width "+w+" ,height " + h);
...
//        mFile = new File(cameraPath, TimeUtils.getCurrentTime() + ".jpg");
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            Log.d(TAG, "onResume: width "+mTextureView.getWidth()+" ,height " + mTextureView.getHeight());
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.d(TAG, "setUpCameraOutputs: displayRotation " + displayRotation);
                ...
                Log.d(TAG, "setUpCameraOutputs: rotatedPreviewWidth "+width+" ,rotatedPreviewHeight " + height);
                ...
                Log.d(TAG, "fit after: PreviewWidth "+mPreviewSize.getWidth()+" ,PreviewHeight " + mPreviewSize.getHeight());
    ...
    private static class ImageSaver implements Runnable {
        ...
        @Override
        public void run() {
            Log.d(TAG, "run: file path" + mFile.getPath());
            ...
            try {
                ...
                output.write(bytes);
                Log.d(TAG, "run: file save finish");
            } catch (IOException e) {
                e.printStackTrace();
                Log.d(TAG, "run: ");
            } finally {
